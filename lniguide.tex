...
%\title{Mit Open Source Hardware/Software und personalisierten Profilen IoT Komponenten im Smart Home steuern}
...
\fancyhead[RO]{\small Smart Home Steuerung mit openHAB und Tinkerforge \hspace{5pt} \thepage \hspace{0.05cm}}
\fancyhead[LE]{\hspace{0.05cm}\small \thepage \hspace{5pt} Roland Dudko und Marvin Lutz}
\fancyfoot{} % Löscht alle Fuzeileneinstellungen
\renewcommand{\headrulewidth}{0.4pt} %Linie unter Kopfzeile 
